...
public class NetworkUtils {
    ...
    public static boolean getMobileDataEnabled() {
        try {
            TelephonyManager tm =
                    (TelephonyManager) ApplicationUtils.getApp().getSystemService(Context.TELEPHONY_SERVICE);
    ...
    public static boolean getWifiEnabled() {
        ...
        WifiManager manager = (WifiManager) ApplicationUtils.getApp().getSystemService(WIFI_SERVICE);
    ...
    public static boolean isWifiConnected() {
        ConnectivityManager cm =
                (ConnectivityManager) ApplicationUtils.getApp().getSystemService(Context.CONNECTIVITY_SERVICE);
    ...
    public static String getIpAddressByWifi() {
        @SuppressLint("WifiManagerLeak")
        WifiManager wm = (WifiManager) ApplicationUtils.getApp().getSystemService(WIFI_SERVICE);
        if (wm == null) return "";
            ...
            Utils.runOnUiThread(new Runnable() {
                ...
                public void run() {
                    ...
                    if (preSize == 0 && mListeners.size() == 1) {
                        ...
                        ApplicationUtils.getApp().registerReceiver(NetworkChangedReceiver.getInstance(), intentFilter);
                    }
                }
            });
        }
            ...
            Utils.runOnUiThread(new Runnable() {
                ...
                public void run() {
                    ...
                    if (preSize == 1 && mListeners.size() == 0) {
                        ApplicationUtils.getApp().unregisterReceiver(NetworkChangedReceiver.getInstance());
                    }
                }
            });
        }
