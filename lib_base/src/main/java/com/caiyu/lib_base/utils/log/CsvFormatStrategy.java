...
public class CsvFormatStrategy implements FormatStrategy {
    ...
    public static final class Builder {
        ...
        @NonNull public CsvFormatStrategy build(String path) {
            if (date == null) {
                date = new Date();
            }
            if (dateFormat == null) {
            ...
            if (logStrategy == null) {
                ...
                if (TextUtils.isEmpty(path)) {
                    diskPath = ApplicationUtils.getApp().getExternalFilesDir("log").getAbsolutePath();
                } else {
                    diskPath = path;
                }
                ...
                logStrategy = new com.orhanobut.logger.DiskLogStrategy(handler);
            }
