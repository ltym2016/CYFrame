...
public class CustomLoadingView extends View {
    ...
    public CustomLoadingView(Context context, AttributeSet attrs) {
        this(context, attrs, R.style.Loading);
    }

    public CustomLoadingView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        TypedArray array = getContext().obtainStyledAttributes(attrs, R.styleable.CustomLoadingView, defStyleAttr, 0);
        mSize = array.getDimensionPixelSize(R.styleable.CustomLoadingView_loading_view_size, StatusBarUtils.dp2px(context, 32));
        mPaintColor = array.getInt(R.styleable.CustomLoadingView_android_color, Color.WHITE);
        array.recycle();
        initPaint();
    }
